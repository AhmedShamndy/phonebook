	...
	<div class="modal" :class="openmodal">
	  ...
	  <div class="modal-card">
	    ...
	    <section class="modal-card-body">
			  ...
			  <div class="control">
			  	<!-- is-danger class work when there is an error -->
			...
			<div class="field">
			  ...
			  <div class="control">
			    <input class="input" :class="{'is-danger':errors.age}" type="number" placeholder="your Age" v-model="list.age">
			  </div>
...
<script>
	export default {
		...
		methods:{
			...
			update(){
				axios.patch(`/phonebook/${this.list.id}`,this.$data.list).then(this.close)
